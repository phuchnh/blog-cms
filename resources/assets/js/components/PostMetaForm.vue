  ...
  <div id="PostMetaForm" class="box">
    ...
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input class="form-control" @change="emitToParent" id="meta_keywords" name="meta_keywords"
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <textarea class="form-control" @change="emitToParent" id="meta_description" name="meta_description"
