    ...
    <div class="box-body">
        <form class="form-horizontal">
            ...
            <div class="form-group" :class="{ 'has-error': errors.first('description') }">
                ...
                <div class="col-sm-8">
                    <textarea v-validate="'required'" class="form-control" name="description" id="description" v-model="post.description" rows="3"></textarea>
            ...
            <div class="form-group">
                <div class="col-md-offset-2 col-md-4">
                    ...
                    <button @click="submit" type="button" class="btn btn-success">{{ formAction === 'create' ? 'Create' : 'Update'}}</button>
                </div>
            </div>
        </form>
    </div>
